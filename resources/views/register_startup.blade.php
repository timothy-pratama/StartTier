...
<form class="login-form">
  ...
  <div class="form-group">
    <label for="inputDeskripsiStartup">Deskripsi Startup</label>
    <textarea class="form-control" id="deskripsiStartup" placeholder="Deskripsi Startup" name="deskripsiStartup" style="resize: vertical" rows="4" required></textarea>
  </div>
  <div class="form-group">
